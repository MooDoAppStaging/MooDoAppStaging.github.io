...
var _htmr = __webpack_require__(39);
...
var Post = function (_React$Component) {
    ...
    _createClass(Post, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: props.excerpt ? '' : 'blog ', id: post.uid ? 'post_' + post.uid : undefined },
                !props.excerpt && _react2.default.createElement(_Nav2.default, { top: true }),
                _react2.default.createElement(
                    'div',
                    { className: 'post' },
                    _react2.default.createElement(
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _reactStatic.Link,
                            { to: '/help/basics', activeClassName: 'selected' },
                            'Get Started'
                        ),
                        _react2.default.createElement(
                            _reactStatic.Link,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        page === 'basics' && _react2.default.createElement(_HelpBasics2.default, null),
...
exports.default = (0, _reactHotLoader.hot)(module)((0, _reactStatic.withRouteData)(function (props) {
    if (props.page) {
        ...
        return _react2.default.createElement(_reactStatic.Redirect, { to: '/help/basics' });
    }
}));
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
                ...
                if (!this.submittingPayment) {
                    ...
                    _util2.default.XHR_PrivateAPI({
                        ...
                        cb: function cb(xhr) {
                            ...
                            if (xhr.status === 200) {
                                this.displayPurchaseSuccess();

                                this.reportAdConversion(purchaseConversionID, parseInt(premiumPrices[premiumPlans.indexOf(this.planID)]));
                            } else {
                                this.displayPurchaseError(PurchaseError.AlreadyPremium);
                            }
                        }
                    });
                }
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            posts.map(function (post) {
                return _react2.default.createElement(_Post2.default, { key: post.title, post: post, excerpt: true });
            })
        ),
        _react2.default.createElement(
            'div',
            ...
            Array(numPages).fill().map(function (a, num) {
                return _react2.default.createElement(
                    _reactStatic.Link,
                    { key: num, to: path + '/' + (num + 1), prefetch: false },
                    num + 1
                );
            })
        )
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 13)), (0, _importCss3.default)('src/containers/Premium', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jay/Documents/code/basketcaseExperiments/Duchess/static/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 14)), (0, _importCss3.default)('src/containers/Help', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
//# sourceMappingURL=static.56c246b5.js.map