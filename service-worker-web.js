var CacheName = 'moodo-cache-1578014493420',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1578014493420.html',
                '/web/js/vendor-1578014493420.js',
                '/web/js/delayedUI-1578014493420.js',
                '/web/js/dimport-1578014493420.js',
                '/web/js/app-1578014493420.js',
                '/web/js/preload-1578014493420.js',
                '/web/js/preload.worker-1578014493420.js',
                '/web/css/app-min-1578014493420.css',
                '/web/css/fonticons-1578014493420.css',
                '/web/css/fonts/fonticons-1578014493420.woff',
                '/web/css/fonts/fonticons-1578014493420.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1578014493420.html');
        }
