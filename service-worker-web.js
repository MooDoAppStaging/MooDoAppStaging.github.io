var CacheName = 'moodo-cache-1610170428606',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1610170428606.html',
                '/web/js/vendor-1610170428606.js',
                '/web/js/delayedUI-1610170428606.js',
                '/web/js/codeBlock-1610170428606.js',
                '/web/js/dimport-1610170428606.js',
                '/web/js/textEncoding-1610170428606.js',
                '/web/js/braintree-1610170428606.js',
                '/web/js/app-1610170428606.js',
                '/web/js/preload-1610170428606.js',
                '/web/js/preload.worker-1610170428606.js',
                '/web/css/app-min-1610170428606.css',
                '/web/css/fonticons-1610170428606.css',
                '/web/css/fonts/fonticons-1610170428606.woff',
                '/web/css/fonts/fonticons-1610170428606.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1610170428606.html');
        }
