var CacheName = 'moodo-cache-1619180000587';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1619180000587.html',
                '/web/js/vendor-1619180000587.js',
                '/web/js/delayedUI-1619180000587.js',
                '/web/js/codeBlock-1619180000587.js',
                '/web/js/dimport-1619180000587.js',
                '/web/js/textEncoding-1619180000587.js',
                '/web/js/braintree-1619180000587.js',
                '/web/js/app-1619180000587.js',
                '/web/js/preload-1619180000587.js',
                '/web/js/preload.worker-1619180000587.js',
                '/web/css/app-min-1619180000587.css',
                '/web/css/fonticons-1619180000587.css',
                '/web/css/fonts/fonticons-1619180000587.woff',
                '/web/css/fonts/fonticons-1619180000587.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1619180000587.html');
        }
