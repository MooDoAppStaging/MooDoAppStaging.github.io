var CacheName = 'moodo-cache-1566934463626',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1566934463626.html',
                '/web/js/vendor-1566934463626.js',
                '/web/js/delayedUI-1566934463626.js',
                '/web/js/dimport-1566934463626.js',
                '/web/js/app-1566934463626.js',
                '/web/js/preload-1566934463626.js',
                '/web/js/preload.worker-1566934463626.js',
                '/web/css/app-min-1566934463626.css',
                '/web/css/fonts/fonticons-1566934463626.woff',
                '/web/css/fonts/fonticons-1566934463626.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1566934463626.html');
        }
