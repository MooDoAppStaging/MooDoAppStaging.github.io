var CacheName = 'moodo-cache-1588424853586',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1588424853586.html',
                '/web/js/vendor-1588424853586.js',
                '/web/js/delayedUI-1588424853586.js',
                '/web/js/dimport-1588424853586.js',
                '/web/js/app-1588424853586.js',
                '/web/js/preload-1588424853586.js',
                '/web/js/preload.worker-1588424853586.js',
                '/web/css/app-min-1588424853586.css',
                '/web/css/fonticons-1588424853586.css',
                '/web/css/fonts/fonticons-1588424853586.woff',
                '/web/css/fonts/fonticons-1588424853586.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1588424853586.html');
        }
