var CacheName = 'moodo-cache-1595087828098',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1595087828098.html',
                '/web/js/vendor-1595087828098.js',
                '/web/js/delayedUI-1595087828098.js',
                '/web/js/codeBlock-1595087828098.js',
                '/web/js/dimport-1595087828098.js',
                '/web/js/app-1595087828098.js',
                '/web/js/preload-1595087828098.js',
                '/web/js/preload.worker-1595087828098.js',
                '/web/css/app-min-1595087828098.css',
                '/web/css/fonticons-1595087828098.css',
                '/web/css/fonts/fonticons-1595087828098.woff',
                '/web/css/fonts/fonticons-1595087828098.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1595087828098.html');
        }
