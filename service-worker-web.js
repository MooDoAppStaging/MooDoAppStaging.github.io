var CacheName = 'moodo-cache-1544444688878',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1544444688878.html',
                '/web/js/vendor-1544444688878.js',
                '/web/js/delayedUI-1544444688878.js',
                '/web/js/dimport-1544444688878.js',
                '/web/js/app-1544444688878.js',
                '/web/js/preload-1544444688878.js',
                '/web/js/preload.worker-1544444688878.js',
                '/web/css/app-min-1544444688878.css',
                '/web/css/fonts/fonticons-1544444688878.woff',
                '/web/css/fonts/fonticons-1544444688878.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1544444688878.html');
        }
