var CacheName = 'moodo-cache-1578796039471',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1578796039471.html',
                '/web/js/vendor-1578796039471.js',
                '/web/js/delayedUI-1578796039471.js',
                '/web/js/dimport-1578796039471.js',
                '/web/js/app-1578796039471.js',
                '/web/js/preload-1578796039471.js',
                '/web/js/preload.worker-1578796039471.js',
                '/web/css/app-min-1578796039471.css',
                '/web/css/fonticons-1578796039471.css',
                '/web/css/fonts/fonticons-1578796039471.woff',
                '/web/css/fonts/fonticons-1578796039471.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1578796039471.html');
        }
