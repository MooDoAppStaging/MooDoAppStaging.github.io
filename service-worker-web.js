var CacheName = 'moodo-cache-1560209009148',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1560209009148.html',
                '/web/js/vendor-1560209009148.js',
                '/web/js/delayedUI-1560209009148.js',
                '/web/js/dimport-1560209009148.js',
                '/web/js/app-1560209009148.js',
                '/web/js/preload-1560209009148.js',
                '/web/js/preload.worker-1560209009148.js',
                '/web/css/app-min-1560209009148.css',
                '/web/css/fonts/fonticons-1560209009148.woff',
                '/web/css/fonts/fonticons-1560209009148.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1560209009148.html');
        }
