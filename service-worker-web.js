var CacheName = 'moodo-cache-1532871393727',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1532871393727.html',
                '/web/js/vendor-1532871393727.js',
                '/web/js/delayedUI-1532871393727.js',
                '/web/js/dimport-1532871393727.js',
                '/web/js/main-min-1532871393727.js',
                '/web/js/preload-min-1532871393727.js',
                '/web/css/app-min-1532871393727.css',
                '/web/css/fonts/fonticons-1532871393727.woff',
                '/web/css/fonts/fonticons-1532871393727.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1532871393727.html');
        }
