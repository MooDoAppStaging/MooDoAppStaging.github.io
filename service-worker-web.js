var CacheName = 'moodo-cache-1591438059003',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1591438059003.html',
                '/web/js/vendor-1591438059003.js',
                '/web/js/delayedUI-1591438059003.js',
                '/web/js/dimport-1591438059003.js',
                '/web/js/app-1591438059003.js',
                '/web/js/preload-1591438059003.js',
                '/web/js/preload.worker-1591438059003.js',
                '/web/css/app-min-1591438059003.css',
                '/web/css/fonticons-1591438059003.css',
                '/web/css/fonts/fonticons-1591438059003.woff',
                '/web/css/fonts/fonticons-1591438059003.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1591438059003.html');
        }
