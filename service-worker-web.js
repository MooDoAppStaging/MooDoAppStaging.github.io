var CacheName = 'moodo-cache-1525677518997',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1525677518997.html',
                '/web/js/vendor-1525677518997.js',
                '/web/js/delayedUI-1525677518997.js',
                '/web/js/dimport-1525677518997.js',
                '/web/js/main-min-1525677518997.js',
                '/web/js/preload-min-1525677518997.js',
                '/web/css/app-min-1525677518997.css',
                '/web/css/fonts/fonticons-1525677518997.woff',
                '/web/css/fonts/fonticons-1525677518997.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1525677518997.html');
        }
