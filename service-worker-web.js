var CacheName = 'moodo-cache-1532004366422',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1532004366422.html',
                '/web/js/vendor-1532004366422.js',
                '/web/js/delayedUI-1532004366422.js',
                '/web/js/dimport-1532004366422.js',
                '/web/js/main-min-1532004366422.js',
                '/web/js/preload-min-1532004366422.js',
                '/web/css/app-min-1532004366422.css',
                '/web/css/fonts/fonticons-1532004366422.woff',
                '/web/css/fonts/fonticons-1532004366422.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1532004366422.html');
        }
