var CacheName = 'moodo-cache-1595241520295',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1595241520295.html',
                '/web/js/vendor-1595241520295.js',
                '/web/js/delayedUI-1595241520295.js',
                '/web/js/codeBlock-1595241520295.js',
                '/web/js/dimport-1595241520295.js',
                '/web/js/app-1595241520295.js',
                '/web/js/preload-1595241520295.js',
                '/web/js/preload.worker-1595241520295.js',
                '/web/css/app-min-1595241520295.css',
                '/web/css/fonticons-1595241520295.css',
                '/web/css/fonts/fonticons-1595241520295.woff',
                '/web/css/fonts/fonticons-1595241520295.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1595241520295.html');
        }
