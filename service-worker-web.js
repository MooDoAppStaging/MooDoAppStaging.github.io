var CacheName = 'moodo-cache-1548826376847',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1548826376847.html',
                '/web/js/vendor-1548826376847.js',
                '/web/js/delayedUI-1548826376847.js',
                '/web/js/dimport-1548826376847.js',
                '/web/js/app-1548826376847.js',
                '/web/js/preload-1548826376847.js',
                '/web/js/preload.worker-1548826376847.js',
                '/web/css/app-min-1548826376847.css',
                '/web/css/fonts/fonticons-1548826376847.woff',
                '/web/css/fonts/fonticons-1548826376847.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1548826376847.html');
        }
