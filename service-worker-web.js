var CacheName = 'moodo-cache-1525323626410',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1525323626410.html',
                '/web/js/vendor-1525323626410.js',
                '/web/js/delayedUI-1525323626410.js',
                '/web/js/dimport-1525323626410.js',
                '/web/js/main-min-1525323626410.js',
                '/web/js/preload-min-1525323626410.js',
                '/web/css/app-min-1525323626410.css',
                '/web/css/fonts/fonticons-1525323626410.woff',
                '/web/css/fonts/fonticons-1525323626410.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1525323626410.html');
        }
