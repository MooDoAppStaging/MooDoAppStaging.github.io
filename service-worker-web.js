var CacheName = 'moodo-cache-1563701157171',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1563701157171.html',
                '/web/js/vendor-1563701157171.js',
                '/web/js/delayedUI-1563701157171.js',
                '/web/js/dimport-1563701157171.js',
                '/web/js/app-1563701157171.js',
                '/web/js/preload-1563701157171.js',
                '/web/js/preload.worker-1563701157171.js',
                '/web/css/app-min-1563701157171.css',
                '/web/css/fonts/fonticons-1563701157171.woff',
                '/web/css/fonts/fonticons-1563701157171.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1563701157171.html');
        }
