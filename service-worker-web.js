var CacheName = 'moodo-cache-1600448366525',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1600448366525.html',
                '/web/js/vendor-1600448366525.js',
                '/web/js/delayedUI-1600448366525.js',
                '/web/js/codeBlock-1600448366525.js',
                '/web/js/dimport-1600448366525.js',
                '/web/js/textEncoding-1600448366525.js',
                '/web/js/braintree-1600448366525.js',
                '/web/js/app-1600448366525.js',
                '/web/js/preload-1600448366525.js',
                '/web/js/preload.worker-1600448366525.js',
                '/web/css/app-min-1600448366525.css',
                '/web/css/fonticons-1600448366525.css',
                '/web/css/fonts/fonticons-1600448366525.woff',
                '/web/css/fonts/fonticons-1600448366525.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1600448366525.html');
        }
