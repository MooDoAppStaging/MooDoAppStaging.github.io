var CacheName = 'moodo-cache-1578741229556',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1578741229556.html',
                '/web/js/vendor-1578741229556.js',
                '/web/js/delayedUI-1578741229556.js',
                '/web/js/dimport-1578741229556.js',
                '/web/js/app-1578741229556.js',
                '/web/js/preload-1578741229556.js',
                '/web/js/preload.worker-1578741229556.js',
                '/web/css/app-min-1578741229556.css',
                '/web/css/fonticons-1578741229556.css',
                '/web/css/fonts/fonticons-1578741229556.woff',
                '/web/css/fonts/fonticons-1578741229556.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1578741229556.html');
        }
