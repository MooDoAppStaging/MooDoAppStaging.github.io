var CacheName = 'moodo-cache-1594976600867',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1594976600867.html',
                '/web/js/vendor-1594976600867.js',
                '/web/js/delayedUI-1594976600867.js',
                '/web/js/codeBlock-1594976600867.js',
                '/web/js/dimport-1594976600867.js',
                '/web/js/app-1594976600867.js',
                '/web/js/preload-1594976600867.js',
                '/web/js/preload.worker-1594976600867.js',
                '/web/css/app-min-1594976600867.css',
                '/web/css/fonticons-1594976600867.css',
                '/web/css/fonts/fonticons-1594976600867.woff',
                '/web/css/fonts/fonticons-1594976600867.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1594976600867.html');
        }
