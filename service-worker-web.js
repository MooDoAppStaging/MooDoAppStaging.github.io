var CacheName = 'moodo-cache-1572238765675',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1572238765675.html',
                '/web/js/vendor-1572238765675.js',
                '/web/js/delayedUI-1572238765675.js',
                '/web/js/dimport-1572238765675.js',
                '/web/js/app-1572238765675.js',
                '/web/js/preload-1572238765675.js',
                '/web/js/preload.worker-1572238765675.js',
                '/web/css/app-min-1572238765675.css',
                '/web/css/fonts/fonticons-1572238765675.woff',
                '/web/css/fonts/fonticons-1572238765675.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1572238765675.html');
        }
