var CacheName = 'moodo-cache-1605257327358',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1605257327358.html',
                '/web/js/vendor-1605257327358.js',
                '/web/js/delayedUI-1605257327358.js',
                '/web/js/codeBlock-1605257327358.js',
                '/web/js/dimport-1605257327358.js',
                '/web/js/textEncoding-1605257327358.js',
                '/web/js/braintree-1605257327358.js',
                '/web/js/app-1605257327358.js',
                '/web/js/preload-1605257327358.js',
                '/web/js/preload.worker-1605257327358.js',
                '/web/css/app-min-1605257327358.css',
                '/web/css/fonticons-1605257327358.css',
                '/web/css/fonts/fonticons-1605257327358.woff',
                '/web/css/fonts/fonticons-1605257327358.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1605257327358.html');
        }
