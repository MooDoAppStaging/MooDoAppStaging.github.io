var CacheName = 'moodo-cache-1625641984626';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1625641984626.html',
                '/web/js/vendor-1625641984626.js',
                '/web/js/delayedUI-1625641984626.js',
                '/web/js/codeBlock-1625641984626.js',
                '/web/js/dimport-1625641984626.js',
                '/web/js/textEncoding-1625641984626.js',
                '/web/js/braintree-1625641984626.js',
                '/web/js/app-1625641984626.js',
                '/web/js/preload-1625641984626.js',
                '/web/js/preload.worker-1625641984626.js',
                '/web/css/app-min-1625641984626.css',
                '/web/css/fonticons-1625641984626.css',
                '/web/css/fonts/fonticons-1625641984626.woff',
                '/web/css/fonts/fonticons-1625641984626.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1625641984626.html');
        }
