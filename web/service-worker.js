var CacheName = 'moodo-cache-1607583982877',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1607583982877.html',
                '/web/js/vendor-1607583982877.js',
                '/web/js/delayedUI-1607583982877.js',
                '/web/js/codeBlock-1607583982877.js',
                '/web/js/dimport-1607583982877.js',
                '/web/js/textEncoding-1607583982877.js',
                '/web/js/braintree-1607583982877.js',
                '/web/js/app-1607583982877.js',
                '/web/js/preload-1607583982877.js',
                '/web/js/preload.worker-1607583982877.js',
                '/web/css/app-min-1607583982877.css',
                '/web/css/fonticons-1607583982877.css',
                '/web/css/fonts/fonticons-1607583982877.woff',
                '/web/css/fonts/fonticons-1607583982877.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1607583982877.html');
        }
