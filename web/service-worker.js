var CacheName = 'moodo-cache-1615727209811';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1615727209811.html',
                '/web/js/vendor-1615727209811.js',
                '/web/js/delayedUI-1615727209811.js',
                '/web/js/codeBlock-1615727209811.js',
                '/web/js/dimport-1615727209811.js',
                '/web/js/textEncoding-1615727209811.js',
                '/web/js/braintree-1615727209811.js',
                '/web/js/app-1615727209811.js',
                '/web/js/preload-1615727209811.js',
                '/web/js/preload.worker-1615727209811.js',
                '/web/css/app-min-1615727209811.css',
                '/web/css/fonticons-1615727209811.css',
                '/web/css/fonts/fonticons-1615727209811.woff',
                '/web/css/fonts/fonticons-1615727209811.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1615727209811.html');
        }
