var CacheName = 'moodo-cache-1615981126858';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1615981126858.html',
                '/web/js/vendor-1615981126858.js',
                '/web/js/delayedUI-1615981126858.js',
                '/web/js/codeBlock-1615981126858.js',
                '/web/js/dimport-1615981126858.js',
                '/web/js/textEncoding-1615981126858.js',
                '/web/js/braintree-1615981126858.js',
                '/web/js/app-1615981126858.js',
                '/web/js/preload-1615981126858.js',
                '/web/js/preload.worker-1615981126858.js',
                '/web/css/app-min-1615981126858.css',
                '/web/css/fonticons-1615981126858.css',
                '/web/css/fonts/fonticons-1615981126858.woff',
                '/web/css/fonts/fonticons-1615981126858.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1615981126858.html');
        }
