var CacheName = 'moodo-cache-1631524647011';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1631524647011.html',
                '/web/js/vendor-1631524647011.js',
                '/web/js/delayedUI-1631524647011.js',
                '/web/js/codeBlock-1631524647011.js',
                '/web/js/dimport-1631524647011.js',
                '/web/js/textEncoding-1631524647011.js',
                '/web/js/braintree-1631524647011.js',
                '/web/js/app-1631524647011.js',
                '/web/js/preload-1631524647011.js',
                '/web/js/preload.worker-1631524647011.js',
                '/web/css/app-min-1631524647011.css',
                '/web/css/fonticons-1631524647011.css',
                '/web/css/fonts/fonticons-1631524647011.woff',
                '/web/css/fonts/fonticons-1631524647011.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1631524647011.html');
        }
