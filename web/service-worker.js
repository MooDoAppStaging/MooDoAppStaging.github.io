var CacheName = 'moodo-cache-1620459004077';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1620459004077.html',
                '/web/js/vendor-1620459004077.js',
                '/web/js/delayedUI-1620459004077.js',
                '/web/js/codeBlock-1620459004077.js',
                '/web/js/dimport-1620459004077.js',
                '/web/js/textEncoding-1620459004077.js',
                '/web/js/braintree-1620459004077.js',
                '/web/js/app-1620459004077.js',
                '/web/js/preload-1620459004077.js',
                '/web/js/preload.worker-1620459004077.js',
                '/web/css/app-min-1620459004077.css',
                '/web/css/fonticons-1620459004077.css',
                '/web/css/fonts/fonticons-1620459004077.woff',
                '/web/css/fonts/fonticons-1620459004077.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1620459004077.html');
        }
