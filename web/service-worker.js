var CacheName = 'moodo-cache-1616241446256';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/web/',
                '/web/index-1616241446256.html',
                '/web/js/vendor-1616241446256.js',
                '/web/js/delayedUI-1616241446256.js',
                '/web/js/codeBlock-1616241446256.js',
                '/web/js/dimport-1616241446256.js',
                '/web/js/textEncoding-1616241446256.js',
                '/web/js/braintree-1616241446256.js',
                '/web/js/app-1616241446256.js',
                '/web/js/preload-1616241446256.js',
                '/web/js/preload.worker-1616241446256.js',
                '/web/css/app-min-1616241446256.css',
                '/web/css/fonticons-1616241446256.css',
                '/web/css/fonts/fonticons-1616241446256.woff',
                '/web/css/fonts/fonticons-1616241446256.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1616241446256.html');
        }
