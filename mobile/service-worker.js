var CacheName = 'moodo-cache-1621919440101';
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/mobile/',
                '/mobile/index-1621919440101.html',
                '/mobile/js/vendor-1621919440101.js',
                '/mobile/js/codeBlock-1621919440101.js',
                '/mobile/js/textEncoding-1621919440101.js',
                '/mobile/js/app-1621919440101.js',
                '/mobile/js/preload-1621919440101.js',
                '/mobile/js/preload.worker-1621919440101.js',
                '/mobile/css/app-min-1621919440101.css',
                '/mobile/css/fonticons-1621919440101.css',
                '/mobile/css/fonts/fonticons-1621919440101.woff',
                '/mobile/css/fonts/fonticons-1621919440101.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1621919440101.html');
        }
