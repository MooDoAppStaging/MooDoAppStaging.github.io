var CacheName = 'moodo-cache-1543782781177',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/newmobile/',
                '/newmobile/index-1543782781177.html',
                '/newmobile/js/vendor-1543782781177.js',
                '/newmobile/js/delayedUI-1543782781177.js',
                '/newmobile/js/app-1543782781177.js',
                '/newmobile/js/preload-1543782781177.js',
                '/newmobile/js/preload.worker-1543782781177.js',
                '/newmobile/css/app-min-1543782781177.css',
                '/newmobile/css/fonts/fonticons-1543782781177.woff',
                '/newmobile/css/fonts/fonticons-1543782781177.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1543782781177.html');
        }
