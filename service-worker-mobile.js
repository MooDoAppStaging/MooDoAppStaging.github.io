var CacheName = 'moodo-cache-1530800496688',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/appmobile/',
                '/appmobile/index-1530800496688.html',
                '/appmobile/js/vendor-1530800496688.js',
                '/appmobile/js/delayedUI-1530800496688.js',
                '/appmobile/js/main-min-1530800496688.js',
                '/appmobile/js/preload-min-1530800496688.js',
                '/appmobile/css/app-min-1530800496688.css',
                '/appmobile/css/fonts/fonticons-1530800496688.woff',
                '/appmobile/css/fonts/fonticons-1530800496688.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1530800496688.html');
        }
