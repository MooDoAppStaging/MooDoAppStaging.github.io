var CacheName = 'moodo-cache-1545045292276',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/newmobile/',
                '/newmobile/index-1545045292276.html',
                '/newmobile/js/vendor-1545045292276.js',
                '/newmobile/js/delayedUI-1545045292276.js',
                '/newmobile/js/app-1545045292276.js',
                '/newmobile/js/preload-1545045292276.js',
                '/newmobile/js/preload.worker-1545045292276.js',
                '/newmobile/css/app-min-1545045292276.css',
                '/newmobile/css/fonts/fonticons-1545045292276.woff',
                '/newmobile/css/fonts/fonticons-1545045292276.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1545045292276.html');
        }
