var CacheName = 'moodo-cache-1544970059418',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/newmobile/',
                '/newmobile/index-1544970059418.html',
                '/newmobile/js/vendor-1544970059418.js',
                '/newmobile/js/delayedUI-1544970059418.js',
                '/newmobile/js/app-1544970059418.js',
                '/newmobile/js/preload-1544970059418.js',
                '/newmobile/js/preload.worker-1544970059418.js',
                '/newmobile/css/app-min-1544970059418.css',
                '/newmobile/css/fonts/fonticons-1544970059418.woff',
                '/newmobile/css/fonts/fonticons-1544970059418.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1544970059418.html');
        }
