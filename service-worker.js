var CacheName = 'moodo-cache-1522834115884',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1522834115884.html',
                '/js/vendor-1522834115884.js',
                '/js/delayedUI-1522834115884.js',
                '/js/dimport-1522834115884.js',
                '/js/main-min-1522834115884.js',
                '/js/preload-min-1522834115884.js',
                '/css/app-min-1522834115884.css',
                '/css/fonts/fonticons-1522834115884.woff',
                '/css/fonts/fonticons-1522834115884.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1522834115884.html');
        }
