var CacheName = 'moodo-cache-1523346864311',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1523346864311.html',
                '/js/vendor-1523346864311.js',
                '/js/delayedUI-1523346864311.js',
                '/js/dimport-1523346864311.js',
                '/js/main-min-1523346864311.js',
                '/js/preload-min-1523346864311.js',
                '/css/app-min-1523346864311.css',
                '/css/fonts/fonticons-1523346864311.woff',
                '/css/fonts/fonticons-1523346864311.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1523346864311.html');
        }
