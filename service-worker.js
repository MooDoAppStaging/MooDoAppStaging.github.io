var CacheName = 'moodo-cache-1520841719829',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1520841719829.html',
                '/js/main-min-1520841719829.js',
                '/js/preload-min-1520841719829.js',
                '/css/app-min-1520841719829.css',
                '/css/fonts/fonticons-1520841719829.woff',
                '/css/fonts/fonticons-1520841719829.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1520841719829.html');
        }
