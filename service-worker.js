var CacheName = 'moodo-cache-1525158222742',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1525158222742.html',
                '/js/vendor-1525158222742.js',
                '/js/delayedUI-1525158222742.js',
                '/js/dimport-1525158222742.js',
                '/js/main-min-1525158222742.js',
                '/js/preload-min-1525158222742.js',
                '/css/app-min-1525158222742.css',
                '/css/fonts/fonticons-1525158222742.woff',
                '/css/fonts/fonticons-1525158222742.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1525158222742.html');
        }
