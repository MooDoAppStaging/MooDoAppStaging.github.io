var CacheName = 'moodo-cache-1524980015505',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1524980015505.html',
                '/js/vendor-1524980015505.js',
                '/js/delayedUI-1524980015505.js',
                '/js/dimport-1524980015505.js',
                '/js/main-min-1524980015505.js',
                '/js/preload-min-1524980015505.js',
                '/css/app-min-1524980015505.css',
                '/css/fonts/fonticons-1524980015505.woff',
                '/css/fonts/fonticons-1524980015505.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1524980015505.html');
        }
