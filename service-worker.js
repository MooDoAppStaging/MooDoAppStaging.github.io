var CacheName = 'moodo-cache-1523440580645',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1523440580645.html',
                '/js/vendor-1523440580645.js',
                '/js/delayedUI-1523440580645.js',
                '/js/dimport-1523440580645.js',
                '/js/main-min-1523440580645.js',
                '/js/preload-min-1523440580645.js',
                '/css/app-min-1523440580645.css',
                '/css/fonts/fonticons-1523440580645.woff',
                '/css/fonts/fonticons-1523440580645.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1523440580645.html');
        }
