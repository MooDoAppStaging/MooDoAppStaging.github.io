var CacheName = 'moodo-cache-1522858961888',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1522858961888.html',
                '/js/vendor-1522858961888.js',
                '/js/delayedUI-1522858961888.js',
                '/js/dimport-1522858961888.js',
                '/js/main-min-1522858961888.js',
                '/js/preload-min-1522858961888.js',
                '/css/app-min-1522858961888.css',
                '/css/fonts/fonticons-1522858961888.woff',
                '/css/fonts/fonticons-1522858961888.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1522858961888.html');
        }
