    ...
    e.waitUntil(
        caches.open('moodo-v1').then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/favicon.ico',
                '/js/main-min-1519978127707.js',
                '/js/preload-min-1519978127707.js',
                '/js/rollbar-min.js',
                '/css/app-min-1519978127707.css',
                '/css/fonts/fonticons-1519978127707.woff',
                '/css/fonts/fonticons-1519978127707.ttf',
                '/img/stripe.png',
