var CacheName = 'moodo-cache-1523962247066',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1523962247066.html',
                '/js/vendor-1523962247066.js',
                '/js/delayedUI-1523962247066.js',
                '/js/dimport-1523962247066.js',
                '/js/main-min-1523962247066.js',
                '/js/preload-min-1523962247066.js',
                '/css/app-min-1523962247066.css',
                '/css/fonts/fonticons-1523962247066.woff',
                '/css/fonts/fonticons-1523962247066.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin || urlObj.href.indexOf('https://cdn.jsdelivr.net/codemirror.spell-checker') === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1523962247066.html');
        }
