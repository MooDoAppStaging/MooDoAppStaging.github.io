var CacheName = 'moodo-cache-1523426299534',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1523426299534.html',
                '/js/vendor-1523426299534.js',
                '/js/delayedUI-1523426299534.js',
                '/js/dimport-1523426299534.js',
                '/js/main-min-1523426299534.js',
                '/js/preload-min-1523426299534.js',
                '/css/app-min-1523426299534.css',
                '/css/fonts/fonticons-1523426299534.woff',
                '/css/fonts/fonticons-1523426299534.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1523426299534.html');
        }
